    ...
    <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl mx-auto mt-24 lg:mt-32 px-6 lg:px-12 text-white relative z-10 gap-12">
      ...
      <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1">
        ...
        <p className="mb-10 max-w-lg text-lg text-purple-200/80 leading-relaxed">
          Let's start with a quick product tour and we will have you up and running in no time. Experience next-gen authentication.
        </p>

        {/* Button */}
        <button className="glass-panel px-10 py-4 text-white bg-white/5 hover:bg-white/10 transition-all rounded-full font-bold text-lg shadow-[0_0_20px_rgba(167,139,250,0.3)] hover:shadow-purple-500/50 hover:scale-[1.02] cursor-pointer">
          Get Started
        </button>
      </div>
